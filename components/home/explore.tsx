  ...
  return (
    <section className="py-10 px-6 bg-white">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        <div className="h-full flex flex-cols-2 gap-5 justify-center items-center relative w-full">
          <Image1 />
        ...
        <div className="w-full items-center justify-center space-x-20">
          <Image2 />
          <div className="bottom-4 left-4 flex justify-between items-center">
        ...
        <div className="flex flex-cols-2 gap-5 justify-center items-center relative w-full">
          <Image4 />
          <div className="items-center">
...
const Icon: React.FC = () => (
  <svg className="mt-2 ml-2 w-8 h-8 fill-current text-[#fa0f00]" viewBox="0 0 512 512">
